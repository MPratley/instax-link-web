  ...
  <div>
    <button class="close-button" v-on:click="showOverlay = true">
      <img
        draggable="false"
        alt="settings icon"
        src="@/assets/icons/printer/menu.svg"
        width="25"
        height="25"
      />
    </button>
    <div v-if="showOverlay" class="overlay">
      <button v-on:click="showOverlay = false" class="close-button">
        <img
          draggable="false"
          alt="close icon"
          src="@/assets/icons/controls/xmark.svg"
          width="20"
          height="20"
        />
      </button>
      <PolaroidSizeSelector
        v-if="!config.connection"
        class="polaroid-size-selector"
        v-on:type-change="typeChangeEvent"
        connected="square"
      />
